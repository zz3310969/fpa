package com.roof.fpa.order.service.api;
...
public interface IOrderService {
	 ...
	 */
	public abstract Serializable save(Order order);
	 ...
	 * 按对象中的非空属性作为条件，进行删除
	 */
	public abstract void deleteByExample(Order order);
	 ...
	 * 按对象中的非空属性作为条件，进行修改
	 */
	public abstract void updateByExample(Order order);
	 ...
	 */
	public abstract Page page(Page page, Order order);
