...
public class AdvisoryProduct implements Serializable {
    ...
    protected AdvisoryPricing advisoryPricing;
    ...
    public AdvisoryPricing getAdvisoryPricing() {
        return advisoryPricing;
    }

    public void setAdvisoryPricing(AdvisoryPricing advisoryPricing) {
        this.advisoryPricing = advisoryPricing;
    }
}
