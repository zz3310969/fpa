...
public class ThemeController {
    ...
    public @ResponseBody
    Result<Page> list(Theme theme, HttpServletRequest request, Model model) {
    ...
    public @ResponseBody
    Result create(@RequestBody Theme theme) {
        if (theme != null) {
    ...
    public @ResponseBody
    Result<ThemeVo> load(@PathVariable Long id) {
    ...
    public @ResponseBody
    Result update(@PathVariable Long id, @RequestBody Theme theme) {
    ...
    Result delete(@PathVariable Long id) {
        ...
        theme.setUseable(DefaultUseableEnum.unusable.getCode());
        themeService.updateIgnoreNull(theme);
