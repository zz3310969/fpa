...
public class CommentTemplateController {
    ...
    public @ResponseBody Result<Page> list(CommentTemplate commentTemplate, HttpServletRequest request) {
	...
	public @ResponseBody Result create(@RequestBody CommentTemplate commentTemplate) {
    ...
    public @ResponseBody Result<CommentTemplateVo> load(@PathVariable Long id) {
	...
	public @ResponseBody Result update(@PathVariable Long id ,@RequestBody CommentTemplate commentTemplate) {
	...
	public @ResponseBody Result delete(@PathVariable Long id ) {
		...
		commentTemplateService.delete(new CommentTemplate(id));
