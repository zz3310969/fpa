...
<%@page import="org.roof.demo.activiti.util.PropertyFileUtil"%>
...
<!--         在填写<strong>会签参与人</strong>字段时使用用户的ID作为值，例如：<code>roof,admin</code>表示两个用户，即两个任务实例被创建。 -->
<!--     </div> -->
...
<!--         <p> -->
<!--             <b><span style="color: red">《Activiti实战》</span></b>：<a target="_blank" href="http://www.roof.me/activiti-in-action.html">http://www.roof.me/activiti-in-action.html</a> -->
<!--         </p> -->
<!--         <p> -->
...
<!--         </p> -->
<!--         <p> -->
<!--             <b>Activiti<span style="color: red">资料</span>：</b><a target="_blank" href="http://www.roof.me/categories.html#activiti-ref">http://www.roof.me/categories.html#activiti-ref</a> -->
<!--         </p> -->
<!--         <p> -->
