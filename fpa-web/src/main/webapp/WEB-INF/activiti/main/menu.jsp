...
<!-- 		</ul></li> -->
	<li><a rel="#">电信卡需求单</a>
		<ul>
			<li><a rel="card/apply">需求申请</a></li>
			<li><a rel="card/list/task">任务列表</a></li>
			<li><a rel="card/list/running">运行中流程</a></li>
			<li><a rel="card/list/finished">已结束流程</a></li>
		</ul></li>
	<!-- 	<li> -->
	<!-- 		<a rel="#">动态表单</a> -->
	<!-- 		<ul> -->
...
<!-- 			<li><a -->
<!-- 				rel="form/dynamic/process-instance/running/list?processType=all">运行中流程表(综合)</a></li> -->
<!-- 			<li><a -->
<!-- 				rel="form/dynamic/process-instance/finished/list?processType=all">已结束流程(综合)</a></li> -->
<!-- 		</ul></li> -->
	<li><a rel="#">管理模块</a>
		<ul>
			<!-- 			<li> -->
